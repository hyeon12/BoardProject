...
public class QFileInfo extends EntityPathBase<FileInfo> {
    ...
    private static final long serialVersionUID = -461924150L;

    public static final QFileInfo fileInfo = new QFileInfo("fileInfo");

    public final org.hyeon.global.entities.QBaseMemberEntity _super = new org.hyeon.global.entities.QBaseMemberEntity(this);
